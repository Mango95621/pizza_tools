...
public class ProcessTool {
    ...
    public static String getCurrentProcessName() {
        ...
        ActivityManager manager = (ActivityManager) ToolInit.getInstance().getApplicationContext().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static boolean isMainProcess() {
        return getCurrentProcessName().equals(AppTool.getAppPackageName(ToolInit.getInstance().getApplicationContext()));
    }
}
