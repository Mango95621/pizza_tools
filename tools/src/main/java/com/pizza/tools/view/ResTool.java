...
public class ResTool {
    ...
    public static String getString(@StringRes int resId) {
        return ToolInit.getInstance().getApplicationContext().getResources().getString(resId);
    }

    public static String getString(@StringRes int resId, Object... os) {
        return ToolInit.getInstance().getApplicationContext().getResources().getString(resId, os);
    }

    public static String[] getStringArray(@ArrayRes int resId) {
        return ToolInit.getInstance().getApplicationContext().getResources().getStringArray(resId);
    }

    // -----------------------------Color--------------------------------------------
    public static int getColor(@ColorRes int resId) {
        return ToolInit.getInstance().getApplicationContext().getResources().getColor(resId);
    }

    public static ColorStateList getColorStateList(int id) {
        Context context = ToolInit.getInstance().getApplicationContext();
    ...
    public static Drawable getDrawable(@DrawableRes int resId, ColorStateList colors, Rect rect) {
        Drawable drawable = ToolInit.getInstance().getApplicationContext().getResources().getDrawable(resId);
    ...
    public static Drawable drawableResize(Drawable image, int resizeWidth, int resizeHeight) {
        ...
        return new BitmapDrawable(
                ToolInit.getInstance().getApplicationContext().getResources(),
                bitmapResized
        );
    }
    ...
    public static String getAssetsText(String fileName) {
        ...
        try {
            // 获取assets资源管理器
            AssetManager assetManager = ToolInit.getInstance().getApplicationContext().getAssets();
            // 通过管理器打开文件并读取
    ...
    public static File getAssetsFile(String filePath) {
        File file =
                new File(ToolInit.getInstance().getApplicationContext().getExternalCacheDir().toString() + "/" + filePath);
        if (!file.exists()) {
        ...
        AssetManager am = ToolInit.getInstance().getApplicationContext().getAssets();
    ...
    public static int getIdByName(String name, String defType) {
        return ToolInit.getInstance().getApplicationContext().getResources()
                .getIdentifier(
                        name, defType,
                        ToolInit.getInstance().getApplicationContext().getPackageName()
                );
    }
