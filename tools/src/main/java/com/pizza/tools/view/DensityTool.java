...
public class DensityTool {
    ...
    public static int dp2px(float dp) {
        float density = ToolInit.getInstance().getApplicationContext().getResources().getDisplayMetrics().density;
    ...
    public static int px2sp(float pxValue) {
        float scale = ToolInit.getInstance().getApplicationContext().getResources().getDisplayMetrics().scaledDensity;
