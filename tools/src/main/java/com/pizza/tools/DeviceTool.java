...
public class DeviceTool {
    ...
    public static String getAppVersionName(Context context) {
        try {
            ...
            PackageInfo packInfo = packageManager.getPackageInfo(ToolInit.getInstance().getApplicationContext().getPackageName(),
    ...
    public static int getAppVersionCode() {
        try {
            // 获取packagemanager的实例
            PackageManager packageManager = ToolInit.getInstance().getApplicationContext().getPackageManager();
            // getPackageName()是你当前类的包名，0代表是获取版本信息
            PackageInfo packInfo = packageManager.getPackageInfo(ToolInit.getInstance().getApplicationContext().getPackageName(),
                    PackageManager.GET_ACTIVITIES);
