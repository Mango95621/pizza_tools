...
public class ZipTool {
    ...
    public static boolean zipFiles(Collection<File> resFiles, String zipFilePath, String comment)
            throws IOException {
        return zipFiles(resFiles, FileTool.get().getFileByPath(zipFilePath), comment);
    }
    ...
    public static boolean zipFiles(Collection<File> resFiles, File zipFile, String comment)
        ...
        try {
            ...
            if (zos != null) {
                zos.finish();
                FileTool.get().getFileOperatorUtil().closeIo(zos);
            }
        }
    }
    ...
    public static boolean zipFile(String resFilePath, String zipFilePath, String comment)
            throws IOException {
        return zipFile(FileTool.get().getFileByPath(resFilePath),
                FileTool.get().getFileByPath(zipFilePath), comment);
    }
    ...
    public static boolean unzipFiles(Collection<File> zipFiles, String destDirPath)
            throws IOException {
        return unzipFiles(zipFiles, FileTool.get().getFileByPath(destDirPath));
    }
    ...
    public static boolean unzipFile(String zipFilePath, String destDirPath)
            throws IOException {
        return unzipFile(FileTool.get().getFileByPath(zipFilePath),
                FileTool.get().getFileByPath(destDirPath));
    }
    ...
    public static List<File> unzipFileByKeyword(String zipFilePath, String destDirPath, String keyword)
            throws IOException {
        return unzipFileByKeyword(FileTool.get().getFileByPath(zipFilePath),
                FileTool.get().getFileByPath(destDirPath), keyword);
    }
    ...
    public static List<File> unzipFileByKeyword(File zipFile, File destDir, String keyword)
        ...
        while (entries.hasMoreElements()) {
            ...
            if (DataTool.isNullString(keyword) ||
                    FileTool.get().getFileGlobalUtil().getFileName(entryName).toLowerCase().contains(keyword.toLowerCase())) {
                String filePath = destDir + File.separator + entryName;
                if (entry.isDirectory()) {
                    if (!FileTool.get().createDir(filePath)) {
                        return null;
                    }
                } else {
                    File file = new File(filePath);
                    files.add(file);
                    if (FileTool.get().createOrSaveFile(file) != null) {
                        return null;
                    }
                    InputStream in = null;
                    ...
                    try {
                        ...
                        FileTool.get().getFileOperatorUtil().closeIo(in, out);
                    }
                }
            }
        }
    ...
    public static List<String> getFilesPath(String zipFilePath)
            throws IOException {
        return getFilesPath(FileTool.get().getFileByPath(zipFilePath));
    }
    ...
    public static List<String> getComments(String zipFilePath)
            throws IOException {
        return getComments(FileTool.get().getFileByPath(zipFilePath));
    }
    ...
    public static Enumeration<?> getEntries(String zipFilePath)
            throws IOException {
        return getEntries(FileTool.get().getFileByPath(zipFilePath));
    }
    ...
    public static String zipEncrypt(String src, String dest, boolean isCreateDir, String password) {
        ...
        if (!DataTool.isNullString(password)) {
