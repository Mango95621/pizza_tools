...
public class AppTool {
    ...
    public static String getAppVersionName() {
        return getAppVersionName(ToolInit.getInstance().getApplicationContext());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(ToolInit.getInstance().getApplicationContext());
    }
    ...
    public static Context getAppContextByPkg(String pkgName) {
        try {
            return ToolInit.getInstance().getApplication()
